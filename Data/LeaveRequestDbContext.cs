...
namespace Modify_Credit.Data
{
    public class LeaveRequestDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>().Property(q=>q.Department).HasMaxLength(100).IsRequired();
            ...
            modelBuilder.Entity<Department>().Property(q=>q.ManagerId).HasMaxLength(10).IsRequired();
            modelBuilder.Entity<Department>().Property(q=>q.ManagerName).HasMaxLength(255).IsRequired();
            ...
            modelBuilder.Entity<Branch>().Property(q=>q.employees).IsRequired().HasMaxLength(255);
            ...
            modelBuilder.Entity<LeaveRequestForm>().Property(q=>q.Employee).IsRequired();
            modelBuilder.Entity<LeaveRequestForm>().Property(q=>q.EmployeeId).IsRequired();
